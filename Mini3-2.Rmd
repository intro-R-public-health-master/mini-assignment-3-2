...
**Due Sunday October 19 through GitHub**
...
This data gives gives the locations of all of the red light cameras in Baltimore City (from Open Baltimore [website](https://data.baltimorecity.gov/datasets/6c9b08a2bb6c40df94e4dec6f2e02cd8_0/explore)).  You read this data into R in the last mini-assignment. 
```{r}
# read in data
